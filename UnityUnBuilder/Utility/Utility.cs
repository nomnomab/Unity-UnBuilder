...
public static partial class Utility {
    ...
    public static bool IsRunningTests = CallingAssemblyName == "UnityUnBuilder.Tests";
    ...
    public static async Task CopyFilesRecursivelyPretty(string sourcePath, string targetPath) {
        AnsiConsole.MarkupLine($"Copying folder \"{sourcePath}\" to \"{targetPath}\"...");
        ...
        await AnsiConsole.Status()
            ...
            .StartAsync("...", async ctx => {
                ...
                foreach (var dirPath in directories) {
                    ...
                    AnsiConsole.MarkupLine($"[grey]Copying folder[/] \"{dirPath}\" to \"{dir}\"");
                ...
                foreach (var newPath in files) {
                    var to = newPath.Replace(sourcePath, targetPath);
                    AnsiConsole.MarkupLine($"[grey]Copying file[/] \"{newPath}\" to \"{to}\"");
    ...
    public static async Task CopyAssets(string sourcePath, string targetPath, HashSet<string> fileBlacklist) {
        ...
        await AnsiConsole.Status()
            ...
            .StartAsync("...", async ctx => {
                ...
                foreach (var dirPath in directories) {
                    var dir = dirPath.Replace(sourcePath, targetPath);
                    AnsiConsole.WriteLine($"Copying dir \"{dirPath}\" to \"{dir}\"");
                ...
                foreach (var file in files) {
                    AnsiConsole.WriteLine($"Copying asset \"{ClampPathFolders(file)}\" to \"{ClampPathFolders(targetPath)}\"");
                    ...
                    AnsiConsole.WriteLine($"Copying asset \"{ClampPathFolders(file)}\" to \"{to}\"");
